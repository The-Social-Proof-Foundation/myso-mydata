...
//! Utility helper functions for working with MyData protocol types.

use crate::move_types::MyDataCommittee;
...
pub fn build_new_to_old_map(
    new_committee: &MyDataCommittee,
    old_committee: &MyDataCommittee,
